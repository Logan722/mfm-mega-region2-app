...
const categoryColors = {
  deliverance: Colors.fire,
  spiritual_warfare: Colors.purple,
  destiny: Colors.gold,
  healing: Colors.success,
  family: Colors.purpleDark,
};
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.8}
          onPress={() => navigation.navigate('DevotionalDetail', { devotional: devotionals[0] })}
        >
          <View style={styles.todayGlow} />
          <View style={styles.todayBadge}>
            <Ionicons name="flame" size={14} color={Colors.fire} />
            <Text style={styles.todayBadgeText}>TODAY'S DEVOTIONAL</Text>
          </View>
          <Text style={styles.todayTitle}>{devotionals[0].title}</Text>
          <Text style={styles.todayVerse} numberOfLines={2}>{devotionals[0].verseOfDay}</Text>
          <View style={styles.todayFooter}>
            <Text style={styles.todayReading}>
              <Ionicons name="book-outline" size={13} color={Colors.purpleLight} />{' '}
              {devotionals[0].bibleReading}
            </Text>
            <View style={styles.todayBtn}>
              <Text style={styles.todayBtnText}>Read</Text>
            ...
            >
              ...
              <View style={styles.devContent}>
                <View style={styles.devHeader}>
                  <Text style={[styles.devCategory, { color: catColor }]}>
...
const styles = StyleSheet.create({
  ...
  todayBadgeText: {
    fontSize: 11, fontWeight: '800', color: Colors.fireLight, letterSpacing: 1.5,
  },
  todayTitle: {
    fontSize: 22, fontWeight: '700', color: Colors.white, lineHeight: 28,
  },
  todayVerse: {
    fontSize: 14, color: Colors.gray300, fontStyle: 'italic', lineHeight: 20, marginTop: 8,
  },
  todayFooter: {
  ...
  todayBtn: {
    ...
    backgroundColor: Colors.fire, paddingHorizontal: 16, paddingVertical: 8,
  ...
  devCard: {
    ...
    marginBottom: Spacing.sm, padding: Spacing.base,
