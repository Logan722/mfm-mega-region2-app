...
export default function LivestreamScreen({ navigation }) {
  const { livestreamSources, livestreamSchedule } = useAppData();
  ...
  const typeColors = { regional: Colors.fire, global: Colors.purple, national: Colors.gold, branch: Colors.purpleLight };
  const typeLabels = { regional: 'MEGA REGION 2', global: 'GLOBAL HQ', national: 'USA HQ', branch: 'BRANCH' };
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Hero */}
      <TouchableOpacity style={styles.hero} activeOpacity={0.85} onPress={() => openYouTube(YOUTUBE_CHANNEL_URL)}>
...
const styles = StyleSheet.create({
  ...
  heroGlow: { position: 'absolute', top: -30, left: -30, width: 120, height: 120, borderRadius: 60, backgroundColor: Colors.fire, opacity: 0.12 },
  heroGlow2: { position: 'absolute', bottom: -20, right: -20, width: 100, height: 100, borderRadius: 50, backgroundColor: Colors.purple, opacity: 0.2 },
  playCircle: { width: 64, height: 64, borderRadius: 32, backgroundColor: Colors.fire, justifyContent: 'center', alignItems: 'center', marginBottom: 12, ...Shadows.fire },
  ...
  heroBtn: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#FF0000', paddingHorizontal: 20, paddingVertical: 10, borderRadius: Radius.full, marginTop: 14 },
  heroBtnText: { fontSize: 14, fontWeight: '700', color: Colors.white },

  tabBar: { flexDirection: 'row', paddingHorizontal: Spacing.base, gap: 8, marginBottom: 4 },
  ...
  sectionLabel: { fontSize: 11, fontWeight: '800', color: Colors.gray500, letterSpacing: 1.5, marginBottom: Spacing.md },

  channelCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.white, borderRadius: Radius.lg, padding: Spacing.base, marginBottom: Spacing.sm, ...Shadows.sm },
  ...
  primaryBadge: { flexDirection: 'row', alignItems: 'center', gap: 3, backgroundColor: Colors.fire + '15', paddingHorizontal: 6, paddingVertical: 2, borderRadius: Radius.full },
  ...
  typeBadge: { alignSelf: 'flex-start', paddingHorizontal: 8, paddingVertical: 2, borderRadius: Radius.full, marginTop: 6 },
  typeText: { fontSize: 9, fontWeight: '800', letterSpacing: 0.5 },

  quickGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12 },
  quickLink: { width: '47%', backgroundColor: Colors.white, borderRadius: Radius.lg, padding: Spacing.base, alignItems: 'center', gap: 8, ...Shadows.sm },
  quickLinkText: { fontSize: 13, fontWeight: '600', color: Colors.gray700 },

  scheduleNote: { fontSize: 12, color: Colors.gray500, fontStyle: 'italic', marginBottom: Spacing.md, lineHeight: 18 },
  scheduleCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.white, borderRadius: Radius.lg, padding: Spacing.base, marginBottom: Spacing.sm, ...Shadows.sm },
  scheduleDay: { backgroundColor: Colors.purpleSoft, borderRadius: Radius.md, paddingHorizontal: 10, paddingVertical: 8, marginRight: 12, minWidth: 70, alignItems: 'center' },
  ...
  infoCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 10, backgroundColor: Colors.purpleSoft, borderRadius: Radius.lg, padding: Spacing.base, marginTop: Spacing.md },
